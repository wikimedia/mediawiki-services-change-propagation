 ...
 * Creates topics.
 *
 * @param {HighLevelProducer} producer a producer to use.
 * @param {Array} topics an array of topic names
 *
 * @returns {Promise} a promise that's resolved when the topics are created.
 */
